...
#raw predictors
model_raw, perf_raw, table_raw = fit_ols_and_report(X_train_raw, y_train, X_test_raw, y_test, feature_cols, "RAW (Set 2)"
)
...
model_log, perf_log, table_log = fit_ols_and_report(
    X_train_log, y_train, X_test_log, y_test, feature_cols, "log (Set 3)"
)
